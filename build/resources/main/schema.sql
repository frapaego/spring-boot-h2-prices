...
CREATE INDEX idx_price_product_id ON price(product_id ASC);
CREATE INDEX idx_price_start_date ON price(start_date ASC);
CREATE INDEX idx_price_end_date ON price(end_date ASC);
CREATE INDEX idx_price_priority ON price(priority ASC);