...
public class PricesIntegrationTest {
    ...
    public void test1_priceAt20200614_1000() throws Exception {
        this.mockMvc.perform(get("/api/price/1/35455").param("startDate", "14-06-2020 10:00:00"))
    ...
    public void test2_priceAt20200614_1600() throws Exception {
        this.mockMvc.perform(get("/api/price/1/35455").param("startDate", "14-06-2020 16:00:00"))
                .andExpect(status().isOk())
    ...
    public void test3_priceAt20200614_2100() throws Exception {
        this.mockMvc.perform(get("/api/price/1/35455").param("startDate", "14-06-2020 21:00:00"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.priceList").value(1))
                .andExpect(jsonPath("$.price").value(35.5));
    }
    ...
    public void test4_priceAt20200615_1000() throws Exception {
        this.mockMvc.perform(get("/api/price/1/35455").param("startDate", "15-06-2020 10:00:00"))
                .andExpect(status().isOk())
    ...
    public void test5_priceAt20200616_2100() throws Exception {
        this.mockMvc.perform(get("/api/price/1/35455").param("startDate", "16-06-2020 21:00:00"))
                .andExpect(status().isOk())
